...
private:
	UPROPERTY()
		TMap<int32, FHHM_Container_SubItem> m_Container_Item;



public:
	class UHHM_Item*			Get_Item_By_ID(int32 _id, int32 _subID = 0);
	const class UHHM_Item*		Get_Item_By_ID_Const(int32 _id, int32 _subID = 0) const;
